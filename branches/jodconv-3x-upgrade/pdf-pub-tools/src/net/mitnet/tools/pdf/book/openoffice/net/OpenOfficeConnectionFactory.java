...
/**
 * Open Office Connection Factory.
 *
...
public class OpenOfficeConnectionFactory {
	...
	public static OpenOfficeConnection createConnection( int port ) {
		OpenOfficeConnection connection = new SocketOpenOfficeConnection( port );
		return connection;
	}
	
	public static OpenOfficeConnection createConnection( String host, int port ) {
